...
public class BreadcrumbCriteria extends Criteria {
    ...
    private List<Map.Entry<VertexRef, GraphProvider>> breadcrumbs = Lists.newArrayList();

    public void setNewRoot(Map.Entry<VertexRef, GraphProvider> newRoot) {
    ...
    public List<Map.Entry<VertexRef, GraphProvider>> getBreadcrumbs() {
