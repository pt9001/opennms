...
public class ReduceFunctionMapper {
    ...
    private static final ReduceFunctionVisitor<AbstractReductionFunctionEntity> serviceToPersistenceMapping = new ReduceFunctionVisitor<AbstractReductionFunctionEntity>() {
        ...
        @Override
        public AbstractReductionFunctionEntity visit(ExponentialPropergation exponentialPropergation) {
            ExponentialPropergationEntity entity = new ExponentialPropergationEntity();
            entity.setBase(exponentialPropergation.getBase());
            return entity;
        }
    };
